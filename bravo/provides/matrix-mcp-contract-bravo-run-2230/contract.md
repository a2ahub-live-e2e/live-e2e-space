---
schema: envelope/v2
id: XC-bravo-matrix-mcp-contract-bravo-run-2230 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:bravo-20260805-89vz
# refs:
#   - {ref: "<XC-id>@<version>", note: "<why>"}
artifacts:
    - path: schema/matrix-mcp-contract-bravo-run-2230.schema.json
      role: schema
      normative: true
      media_type: application/schema+json
    - path: fixtures/valid/matrix-mcp-contract-bravo-run-2230.json
      role: valid-fixture
      normative: true
      media_type: application/json
      conforms_to: schema/matrix-mcp-contract-bravo-run-2230.schema.json
    - path: fixtures/invalid/matrix-mcp-contract-bravo-run-2230.json
