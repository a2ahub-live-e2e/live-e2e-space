---
schema: envelope/v2
id: XC-bravo-matrix-contract-lifecycle-run-2344 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:bravo-20260805-e58p
# refs:
