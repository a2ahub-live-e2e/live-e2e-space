---
schema: envelope/v2
id: XC-alpha-ac973-registered-consumer-run-2230 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
created: 2026-08-05T03:08:00Z
category: other
priority: p3
blocking: false
classification: internal
version: 2.0.0 # unpublished — `a2a contract publish` establishes the first real version. Leave it; a draft that already reads the version you publish has no establishing commit and can never be resolved afterwards.
...
thread: thread:alpha-20260805-97mg
# refs:
#   - {ref: "<XC-id>@<version>", note: "<why>"}
artifacts:
    - path: schema/ac973-registered-consumer-run-2230.schema.json
      role: schema
      normative: true
      media_type: application/schema+json
    - path: fixtures/valid/ac973-registered-consumer-run-2230.json
      role: valid-fixture
      normative: true
      media_type: application/json
      conforms_to: schema/ac973-registered-consumer-run-2230.schema.json
    - path: fixtures/invalid/ac973-registered-consumer-run-2230.json
