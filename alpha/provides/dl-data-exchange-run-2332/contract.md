---
schema: envelope/v2
id: XC-alpha-dl-data-exchange-run-2332 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260805-zjn0
# refs:
#   - {ref: "<XC-id>@<version>", note: "<why>"}
artifacts:
    - path: schema/dl-data-exchange-run-2332.schema.json
      role: schema
      normative: true
      media_type: application/schema+json
    - path: fixtures/valid/dl-data-exchange-run-2332.json
      role: valid-fixture
      normative: true
      media_type: application/json
      conforms_to: schema/dl-data-exchange-run-2332.schema.json
    - path: fixtures/invalid/dl-data-exchange-run-2332.json
