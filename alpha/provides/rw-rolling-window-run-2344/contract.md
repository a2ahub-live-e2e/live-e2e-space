---
schema: envelope/v2
id: XC-alpha-rw-rolling-window-run-2344 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
created: 2026-08-05T11:01:50Z
category: other
priority: p3
blocking: false
classification: internal
version: 1.2.0 # set by `a2a contract publish`, never by hand — see the note at the bottom
...
thread: thread:alpha-20260805-0rx1
# refs:
#   - {ref: "<XC-id>@<version>", note: "<why>"}
artifacts:
    - path: schema/rw-rolling-window-run-2344.schema.json
      role: schema
      normative: true
      media_type: application/schema+json
    - path: fixtures/valid/rw-rolling-window-run-2344.json
      role: valid-fixture
      normative: true
      media_type: application/json
      conforms_to: schema/rw-rolling-window-run-2344.schema.json
    - path: fixtures/invalid/rw-rolling-window-run-2344.json
