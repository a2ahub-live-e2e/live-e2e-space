---
schema: envelope/v2
id: XC-alpha-ac973-registered-consumer-run-2344 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260805-62pd
# refs:
#   - {ref: "<XC-id>@<version>", note: "<why>"}
artifacts:
    - path: schema/ac973-registered-consumer-run-2344.schema.json
      role: schema
      normative: true
      media_type: application/schema+json
    - path: fixtures/valid/ac973-registered-consumer-run-2344.json
      role: valid-fixture
      normative: true
      media_type: application/json
      conforms_to: schema/ac973-registered-consumer-run-2344.schema.json
    - path: fixtures/invalid/ac973-registered-consumer-run-2344.json
