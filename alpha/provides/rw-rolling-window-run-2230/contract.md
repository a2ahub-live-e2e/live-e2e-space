---
schema: envelope/v2
id: XC-alpha-rw-rolling-window-run-2230 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260805-3wdn
# refs:
#   - {ref: "<XC-id>@<version>", note: "<why>"}
artifacts:
    - path: schema/rw-rolling-window-run-2230.schema.json
      role: schema
      normative: true
      media_type: application/schema+json
    - path: fixtures/valid/rw-rolling-window-run-2230.json
      role: valid-fixture
      normative: true
      media_type: application/json
      conforms_to: schema/rw-rolling-window-run-2230.schema.json
    - path: fixtures/invalid/rw-rolling-window-run-2230.json
