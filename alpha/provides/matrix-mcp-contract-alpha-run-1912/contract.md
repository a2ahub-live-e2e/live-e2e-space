---
schema: envelope/v1
id: XC-alpha-matrix-mcp-contract-alpha-run-1912 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260801-6xfy
