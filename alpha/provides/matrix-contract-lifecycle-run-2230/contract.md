---
schema: envelope/v2
id: XC-alpha-matrix-contract-lifecycle-run-2230 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260805-hate
# refs:
