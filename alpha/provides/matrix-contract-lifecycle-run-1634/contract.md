---
schema: envelope/v1
id: XC-alpha-matrix-contract-lifecycle-run-1634 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260729-tetk
