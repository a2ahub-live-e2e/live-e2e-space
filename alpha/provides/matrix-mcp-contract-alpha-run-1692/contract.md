---
schema: envelope/v1
id: XC-alpha-matrix-mcp-contract-alpha-run-1692 # e.g. XC-axon-ingest — standing ID grammar §3.3
type: contract
...
thread: thread:alpha-20260730-gcej
